...
ScenarioInfo = {
    ...
    map = '/maps/aeon_illuminate_survival.v0010/aeon_illuminate_survival.scmap',
    save = '/maps/aeon_illuminate_survival.v0010/aeon_illuminate_survival_save.lua',
    script = '/maps/aeon_illuminate_survival.v0010/aeon_illuminate_survival_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
