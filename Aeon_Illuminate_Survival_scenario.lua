...
ScenarioInfo = {
    ...
    map = '/maps/aeon_illuminate_survival.v0003/Aeon_Illuminate_Survival.scmap',
    save = '/maps/aeon_illuminate_survival.v0003/Aeon_Illuminate_Survival_save.lua',
    script = '/maps/aeon_illuminate_survival.v0003/Aeon_Illuminate_Survival_script.lua',
    norushradius = 40,
    Configurations = {
        ['standard'] = {
            teams = {
